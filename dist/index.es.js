...
var Slider = function (_a) {
    ...
    var _b = useState(defautValue), value = _b[0], setValue = _b[1];
...
var Clock = function (_a) {
    ...
    var _b = useState(getCurrentTime()), currentTime = _b[0], setCurrentTime = _b[1];
    useEffect(function () {
...
export { AccordionGroup as Accordion, Avatar, Badge, Breadcrumbs as BreadCrumbs, Button$1 as Button, ButtonGroup, Card, Carousel, Clock, DatePicker, Dropdown, FormValidation, Input$2 as Input, List, Modal, Pagination, ProgressBar, Rating, SearchBar, Sidebar as SideBar, Slider, Spinner, Stopwatch as StopWatch, Table, Tabs, Textarea, TimePicker, Toast, Toggle, Tooltip };
